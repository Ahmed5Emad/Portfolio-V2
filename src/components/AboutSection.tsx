      ...
      <div className="max-w-6xl w-full relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 space-y-6">
            <div>
              <h1 className="text-gray-900 dark:text-white mb-3 text-5xl lg:text-6xl">Ahmed Emad</h1>
              <div className="min-h-[50px] text-2xl lg:text-3xl">
                <TypewriterText texts={["UI/UX Designer", "Front-End Engineer", "Creative Developer"]} />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex flex-wrap gap-4">
                ...
                <a 
                  href="#contact"
                  className="flex items-center gap-2 px-6 py-3 bg-gray-100 dark:bg-[#1e1e1e] text-gray-900 dark:text-white border border-orange-500/30 rounded-xl hover:border-orange-500 transition-all duration-300 hover:scale-105"
                >
                  Let's Talk
                </a>
              </div>
