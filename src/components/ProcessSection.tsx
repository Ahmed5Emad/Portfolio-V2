...
export function ProcessSection() {
  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-b from-[#121212] via-[#1a1a1a] to-[#121212]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, index) => (
            <div key={index} className="relative group">
              ...
              <div className="relative h-full p-6 rounded-2xl bg-[#1e1e1e] border border-white/10 hover:border-orange-500/50 transition-all duration-300 hover:scale-105">
                {/* Number Badge */}
                <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center text-white">
                  {index + 1}
                </div>
